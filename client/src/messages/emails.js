...
module.exports = {
  ...
  TEAM_CREATED: {
    status: "Team Created",
    body: "Your Stratbook team has been created.",
    email_body: "<div><h2>Your Stratbook team has been created.</h2><br/><p>Congratulations on creating a team on Stratbook. You may now send the join code to other members on the same platform as you to invite them to join your team. You and your team can create strategies for your own stratbook.</p></div>"
  },
  TEAM_DISBANDED: {
    status: "Team Disbanded",
    body: "Your Stratbook team has been disbanded.",
    email_body: "<div><h2>Your Stratbook team has been disbanded.</h2><br/><p>Due to the actions of an admin on the team, your Stratbook team has been disbanded. All associated data has been removed from the database.</p></div>"
  },
  TEAM_NAME_UPDATED: {
    status: "Team Name Updated",
    body: "Your team name has been updated.",
    email_body: "<div><h2>Your team name has been updated</h2><br/><p>Your Stratbook team name has been updated. If you wish to undo this as an admin on the team, login and revert the change.</p></div>"
  },
  ...
  USER_JOINED_TEAM: {
    ...
    body: "A user joined your Stratbook team.",
    email_body: "<div><h2>A user joined your Stratbook team.</h2></br><p>A user has joined your Stratbook team. Log in to Stratbook to see the new user and if needed, remove them.</p></div>"
  },
  USER_LEFT_TEAM: {
    status: "User Left Team",
    body: "A user left your Stratbook team.",
    email_body: "<div><h2>A user left your Stratbook team</h2><br/><p>A user has left your Stratbook team.</p></div>"
  },
  USER_REGISTERED: {
