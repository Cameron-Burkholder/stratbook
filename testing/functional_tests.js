...
suite("FUNCTIONAL TESTS", function() {
  ...
  */
  ...
  suite("STRATEGIES MODEL", function() {
    ...
    suite("/api/strategies/create", function() {
      const invalidJWT = "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE1OTg4MTkxMTk3NDQsImV4cCI6MTU5ODgxOTExOTc0NH0.qkun-NSiUKZ-lC0tW6g0eu8VWqUSAxzQZbG4alpfXeSbL3_SPlfS87FHgRMaJeYkNb2qwqq8blq3JjvK5jYYxRhwfecOFvBsCnjzVrr-q4WRUm_PvJMdYW1TDK6iQwmuv8n2PP9vyz558ne9m065Ufqf1fn_3NIdSHNzsGkWf_tJYKX9d8ChxMn2L6pVtnetolD9KHgajJzpS9llbO7VUOSsnbuv8eMxo3N3Jlgw1NViarxYfctNhj7mL_PynlTqxSeRxpXR5vGqbCU7XP7y34gqrj9p7wsNklwsYaqGqr9oVbo0Ai5rtNRukykQ5MDB6rH15WQpcPH1JBi03bZMA407IgHsJXUo0p9Nv9pFDqLqfIuB-LQcA8ALjViPQ9L_v_g2PxU-47DEALtRldTobu4tKTQ8yAOc0mw6Da8SgpML8sysBmC6uCzFlkcw9u9LNrLVmkmcUYSrtJwtJeXOGeUhICumhHl-NsYmguJht4tTa56SRUfkcZZL7i4uxnS36pF66A_V0NU1jqeKWFaWzBhLPLEy7HAuWuSyLOrS5haS40S70Pz6s_Bf6ED1R0lPd6tjtIVIlAJ3JLkGouzR2s1sETySmQlKDSi7fQ9e0Bvfrow10QhcExG7bdkxQ58xDhXh8KnY4jLH1vqhA6TSX7TFOJtgOtxSA2NvDym7uRo";
        ...
        chai.request(server)
          ...
          .send({
            strategy: {
              name: "New Strategy",
              type: "ATTACK",
              execution: "Something to execute",
              objectives: ["Get main wall"],
              roles: ["HARD BREACH", "SOFT BREACH", "UTILITY CLEAR", "SUPPORT", "AREA DENIAL/FLANK WATCH"],
              utility: ["ANY", "ANY", "ANY", "ANY", "ANY"],
              operators: ["THERMITE", "ZOFIA", "THATCHER", "DOKKAEBI", "CAPITAO"]
            }
          })
          .end((error, response) => {
            if (error) return done(error);
      ...
      test("# Strategy created", function(done) {
        chai.request(server)
          .post("/api/strategies/create")
          .set({ Authorization: fakeUserJWT2 })
          .send({
          ...
          .end((error, response) => {
            if (error) return done(error);
            assert.equal(response.status, 200, "Response should be 200 if strategies are found.");
            assert.equal(response.body.status, "STRATEGY_CREATED", "Response should indicate strategy was created.");
            done();
          });
      });
    });

    suite("/api/strategies/update", function() {
      const invalidJWT = "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE1OTg4MTkxMTk3NDQsImV4cCI6MTU5ODgxOTExOTc0NH0.qkun-NSiUKZ-lC0tW6g0eu8VWqUSAxzQZbG4alpfXeSbL3_SPlfS87FHgRMaJeYkNb2qwqq8blq3JjvK5jYYxRhwfecOFvBsCnjzVrr-q4WRUm_PvJMdYW1TDK6iQwmuv8n2PP9vyz558ne9m065Ufqf1fn_3NIdSHNzsGkWf_tJYKX9d8ChxMn2L6pVtnetolD9KHgajJzpS9llbO7VUOSsnbuv8eMxo3N3Jlgw1NViarxYfctNhj7mL_PynlTqxSeRxpXR5vGqbCU7XP7y34gqrj9p7wsNklwsYaqGqr9oVbo0Ai5rtNRukykQ5MDB6rH15WQpcPH1JBi03bZMA407IgHsJXUo0p9Nv9pFDqLqfIuB-LQcA8ALjViPQ9L_v_g2PxU-47DEALtRldTobu4tKTQ8yAOc0mw6Da8SgpML8sysBmC6uCzFlkcw9u9LNrLVmkmcUYSrtJwtJeXOGeUhICumhHl-NsYmguJht4tTa56SRUfkcZZL7i4uxnS36pF66A_V0NU1jqeKWFaWzBhLPLEy7HAuWuSyLOrS5haS40S70Pz6s_Bf6ED1R0lPd6tjtIVIlAJ3JLkGouzR2s1sETySmQlKDSi7fQ9e0Bvfrow10QhcExG7bdkxQ58xDhXh8KnY4jLH1vqhA6TSX7TFOJtgOtxSA2NvDym7uRo";
        ...
        chai.request(server)
          ...
          .send({
            ...
            strategy: {
              ...
              type: "ATTACK",
              execution: "Something new to execute",
              objectives: ["Get main wall"],
              roles: ["HARD BREACH", "SOFT BREACH", "UTILITY CLEAR", "SUPPORT", "AREA DENIAL/FLANK WATCH"],
              utility: ["ANY", "ANY", "ANY", "ANY", "ANY"],
              operators: ["THERMITE", "ZOFIA", "THATCHER", "DOKKAEBI", "CAPITAO"]
      ...
      test("# Strategy deleted", function(done) {
        chai.request(server)
          ...
          .end((error, response) => {
            if (error) return done(error);
            assert.equal(response.status, 200, "Response should be 200 if strategies are found.");
            assert.equal(response.body.status, "STRATEGY_UPDATED", "Response should indidicate strategy was deleted.");
            done();
          });
      });
    });

    suite("/api/strategies/delete", function() {
      const invalidJWT = "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE1OTg4MTkxMTk3NDQsImV4cCI6MTU5ODgxOTExOTc0NH0.qkun-NSiUKZ-lC0tW6g0eu8VWqUSAxzQZbG4alpfXeSbL3_SPlfS87FHgRMaJeYkNb2qwqq8blq3JjvK5jYYxRhwfecOFvBsCnjzVrr-q4WRUm_PvJMdYW1TDK6iQwmuv8n2PP9vyz558ne9m065Ufqf1fn_3NIdSHNzsGkWf_tJYKX9d8ChxMn2L6pVtnetolD9KHgajJzpS9llbO7VUOSsnbuv8eMxo3N3Jlgw1NViarxYfctNhj7mL_PynlTqxSeRxpXR5vGqbCU7XP7y34gqrj9p7wsNklwsYaqGqr9oVbo0Ai5rtNRukykQ5MDB6rH15WQpcPH1JBi03bZMA407IgHsJXUo0p9Nv9pFDqLqfIuB-LQcA8ALjViPQ9L_v_g2PxU-47DEALtRldTobu4tKTQ8yAOc0mw6Da8SgpML8sysBmC6uCzFlkcw9u9LNrLVmkmcUYSrtJwtJeXOGeUhICumhHl-NsYmguJht4tTa56SRUfkcZZL7i4uxnS36pF66A_V0NU1jqeKWFaWzBhLPLEy7HAuWuSyLOrS5haS40S70Pz6s_Bf6ED1R0lPd6tjtIVIlAJ3JLkGouzR2s1sETySmQlKDSi7fQ9e0Bvfrow10QhcExG7bdkxQ58xDhXh8KnY4jLH1vqhA6TSX7TFOJtgOtxSA2NvDym7uRo";
      ...
      test("# Strategy deleted", function(done) {
        chai.request(server)
          ...
          .end((error, response) => {
            if (error) return done(error);
            assert.equal(response.status, 200, "Response should be 200 if strategies are found.");
            assert.equal(response.body.status, "STRATEGY_DELETED", "Response should indidicate strategy was deleted.");
            done();
          });
      });
    });
